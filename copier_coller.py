...
# Paramètres
source_image_path = r'/content/samples/milano/m1.png' # choose the image to generate from
patch_size = 60  
overlap = 20    
...
results_folder = "/content/INN-project/results" # choose the folder to save in
os.makedirs(results_folder, exist_ok=True)
synthesized_texture.save(os.path.join(results_folder, "synthesized_texture.png"))
source_image.save(os.path.join(results_folder, "source_image.png"))
